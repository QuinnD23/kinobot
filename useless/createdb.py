    ...
    with conn:
        with conn.cursor(cursor_factory=psycopg2.extras.DictCursor) as cur:
            ...
            try:
                ...
                pass
            try:
                cur.execute("CREATE TABLE maxi (id_maxi varchar primary key, genre integer default 0, min_year integer default 0, max_year integer default 0, kol integer default 0);")
            except:
                pass
